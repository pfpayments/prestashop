...
To install module manually by dragging up zip file, please download [.zip archive](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop/2.0.2/postfinancecheckout.zip) of module with correct structure required by Prestashop installation
...
* [English](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop/2.0.2/docs/en/documentation.html)
...
Please see the [license file](https://github.com/pfpayments/prestashop/blob/2.0.2/LICENSE) for more information.
