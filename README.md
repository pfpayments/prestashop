...
To install module manually by dragging up zip file, please download [.zip archive](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop/2.0.7/postfinancecheckout.zip) of module with correct structure required by Prestashop installation
...
* [PHP](http://php.net/) 8.1 (minimum PHP version supported by Prestashop 9 version)

## Documentation

* [English](https://plugin-documentation.postfinance-checkout.ch/pfpayments/prestashop/2.0.7/docs/en/documentation.html)
...
Please see the [license file](https://github.com/pfpayments/prestashop/blob/2.0.7/LICENSE) for more information.
