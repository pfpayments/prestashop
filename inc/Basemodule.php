...
class PostFinanceCheckoutBasemodule
{
    ...
    public static function checkRequirements(PostFinanceCheckout $module)
    {
        try {
    ...
    private static function installControllers(PostFinanceCheckout $module)
    {
    ...
    private static function executeSettingsChangedHook(PostFinanceCheckout $module)
    {
    ...
    public static function hookActionOrderGridQueryBuilderModifier(PostFinanceCheckout $module, $params)
    {
    ...
    public static function hookActionOrderGridDefinitionModifier(PostFinanceCheckout $module, $params)
    {
    ...
    public static function hookDisplayAdminOrder(PostFinanceCheckout $module, $params)
    {
        ...
        $module->getContext()->smarty->assign($templateVars);
        PostFinanceCheckoutVersionadapter::getAdminOrderTemplate();
